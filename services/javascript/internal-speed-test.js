...
const getData = (callback) => {
    axios.get('http://127.0.0.1:3025/api/internalspeeds/read')
...
const postData = (data) => {
    axios.post('http://127.0.0.1:3025/api/internalspeeds/create', data)
        .then(function (response) {
...
const updateData = (id, data) => {
    axios.post(`http://127.0.0.1:3025/api/internalspeeds/update/${id}`, data)
        .then(function (response) {
            // console.log(response.data);
