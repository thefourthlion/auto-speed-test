...
const getData = (callback) => {
    axios.get('http://192.168.0.66:4001/api/internalspeeds/read')
...
const postData = (data) => {
    axios.post('http://192.168.0.66:4001/api/internalspeeds/create', data)
        .then(function (response) {
...
const updateData = (id, data) => {
    axios.post(`http://192.168.0.66:4001/api/internalspeeds/update/${id}`, data)
        .then(function (response) {
            // console.log(response.data);
