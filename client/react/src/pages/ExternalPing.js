...
const ExternalPing = () => {
    ...
    const postURL = 'https://apispeeds.portkeylabs.net/api/externalping/create';
    const getURL = "https://apispeeds.portkeylabs.net/api/externalping/read";
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`https://apispeeds.portkeylabs.net/api/externalping/delete/${id}`);
            console.log('Response:', response.data);
            refreshPage()
        } catch (error) {
            console.error('Error:', error);
