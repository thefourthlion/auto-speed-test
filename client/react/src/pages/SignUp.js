...
const Register = () => {
  ...
  const getUsers = async () => {
    try {
      const response = await axios.get('https://apispeeds.portkeylabs.net/api/auth/read');
  ...
  const deleteUsers = async (id) => {
    try {
      const response = await axios.delete(`https://apispeeds.portkeylabs.net/api/auth/delete/${id}`);
      console.log(response.data)
      refreshPage()
    } catch (error) {
      console.error('Error fetching data: ', error);
