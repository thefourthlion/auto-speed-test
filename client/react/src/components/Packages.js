...
const Packages = () => {
    ...
    const getData = async () => {
        try {
            const response = await axios.get('https://apispeeds.portkeylabs.net/api/packages/read');
    ...
    const handleSubmit = async () => {
        try {
            const response = await axios.post('https://apispeeds.portkeylabs.net/api/packages/create', data);
    ...
    const deleteItem = async (id) => {
        try {
            const response = await axios.delete(`https://apispeeds.portkeylabs.net/api/packages/delete/${id}`);
            console.log(response.data)
            refreshPage()
        } catch (error) {
            console.error('Error:', error);
