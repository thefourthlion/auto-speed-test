...
const ReportsList = () => {
    ...
    const postURL = 'https://apispeeds.portkeylabs.net/api/reportslist/create';
    const getURL = "https://apispeeds.portkeylabs.net/api/reportslist/read";
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`https://apispeeds.portkeylabs.net/api/reportslist/delete/${id}`);
            console.log('Response:', response.data);
            refreshPage()
        } catch (error) {
            console.error('Error:', error);
