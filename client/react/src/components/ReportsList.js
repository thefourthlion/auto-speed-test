...
const ReportsList = () => {
    ...
    const postURL = 'http://10.49.48.150:3025/api/reportslist/create';
    const getURL = "http://10.49.48.150:3025/api/reportslist/read";
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`http://10.49.48.150:3025/api/reportslist/delete/${id}`);
            console.log('Response:', response.data);
            refreshPage()
        } catch (error) {
            console.error('Error:', error);
